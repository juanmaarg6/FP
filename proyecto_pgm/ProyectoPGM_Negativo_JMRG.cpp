/*
	Programa que, dada una imagen.pgm, muestra el negativo de 
	dicha imagen.
...
/*
	Funcion que calcula el negativo de la imagen.
...
int main(){
	...
	/*
		...
		Se calcula el negativo de la imagen final.
