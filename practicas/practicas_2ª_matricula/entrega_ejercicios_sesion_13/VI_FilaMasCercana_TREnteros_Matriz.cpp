/*
	...
	Ampliar la clase TablaRectangularEnteros con un método que busca la fila 
	de la matriz que más se parezca a un vector de enteros (clase 
	SecuenciaEnteros) al que llamaremos "referencia". El método devuelve el 
	número de la fila. La similitud entre dos vectores vendrá dada por la
