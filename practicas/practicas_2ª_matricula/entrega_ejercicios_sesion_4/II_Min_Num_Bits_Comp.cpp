/*
	...
	Modificación del Ejercicio 35
	de la Relación de Ejercicios 1: Programa que, dado un número entero, 
								    calcula el mínimo número de dígitos que se 
									necesitan para su representación en 
									binario.
...
int main() {				
	...
	/*
		...
		Si 'n' es mayor o igual que 0:
			...
			Si el numero introducido es mayor que 0, aux tiene el valor 1. En 
			caso contrario, aux tiene el valor 0.
