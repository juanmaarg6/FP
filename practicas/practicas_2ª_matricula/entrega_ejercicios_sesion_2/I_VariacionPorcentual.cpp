/*
	...
	Entradas: Valor inicial del producto (valor_inicial), 
...
int main() {	
	...
	double valor_inicial, valor_final, var_porcentual;	 
	...
	/*
		...
		Calcular la varianza porcentual mediante la siguiente fórmula:
