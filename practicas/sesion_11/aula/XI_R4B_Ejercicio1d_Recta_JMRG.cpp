/*
	Ejercicio 1d): Programa que, dadas dos rectas,
...
class Recta{
	...
	public:
		/*
			Funcion que establece los coeficientes de la recta.
			
			Parametros: valor_a (double), valor_b (double), valor_c (double).
			
			Devuelve: -
		*/
		void EstablecerCoeficientes(double valor_a, double valor_b, double valor_c);
...
void LeerCoeficientes(Recta &recta){
	...
	*/
	...
	recta.EstablecerCoeficientes(coeficiente_a, coeficiente_b, coeficiente_c);
}

void Recta::EstablecerCoeficientes(double valor_a, double valor_b, double valor_c){
