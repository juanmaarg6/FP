...
int main(){	
	...
	/* 
		...
		asignan en ambas un número de 9 cifras. Después se multiplican y el resultado se almacena
		...
		El programa muestra como resultado el valor 142596044. El verdadero resultado debería ser
	...
	*/
	...
	/* 
		...
		asignan en ambas un número de 3 cifras enteras y 1 cifra real. Después se multiplican y 
		el resultado se almacena en la variable real "resultado_a". Al mostrarse en pantalla, 
		se observa un resultado con más cifras decimales de las que tendría que haber realmente. 	
		
		El programa muestra como resultado el valor 15289.020000000000437. El verdadero resultado 
		debería ser 15289.02. Esto se debe a que toda parte real se representa siempre de forma
		aproximada.
	...
	*/
	...
	/* 
		...
		asignan en ambas un número de 9 cifras enteras y 1 cifra real. Después se multiplican y 
		...
		debería ser 15241578787227558.72. Esto se debe a que el resultado tiene más de 16 dígitos, 
		de forma que su representación no es exacta (se pierden dígitos).
	...
	*/
	...
	/* 
		...
		asigna un valor de 2e34 a la variable "real_e". Después se asigna a la variable "otro_real_e"
		el valor "real_e + 1". Finalmente, se calcula la diferencia de esos números y se almacena en "resultado_e". 
		...
		debería ser 1. Esto se debe a que el número 2e34 + 1 tiene más de 16 dígitos, de forma que su 
		representación no es exacta (se pierden dígitos). Así que el resultado de 2e34 + 1 es 2e34.
	...
	*/
	...
	/* 
		...
		Después se multiplican y el resultado se almacena en la variable real "resultado_f". Al mostrarse en pantalla, se observa 
		un resultado erróneo.
		
		El programa muestra como resultado "inf", es decir, infinito. El verdadero resultado 
		debería ser 1e+500. Esto se debe a que los reales no se desbordan de la misma forma que los enteros, mostrando de
	...
	*/
	...
	/* 
		...
		asigna un valor de 2e+150 a la variable "grande_g". Después se asigna ese mismo valor a la variable "chico_g".
		Al mostrarse en pantalla, se observa un resultado erróneo.
		
		El programa muestra como resultado "inf", es decir, infinito. El verdadero resultado 
		debería ser 2e+150. Esto se debe a que los reales en coma flotante no se desbordan de la misma forma que los enteros, 
