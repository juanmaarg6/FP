/*
	Programa que lee un mensaje extraterrestre y muestra
	los números primos que forman el número secreto
	de dicho mensaje extraterrestre.
		...
		Hacer...:
			...
			Sino (en este caso, "numero = 0"):
				...
				Si "contador_de_1" es distinto de 0:
					Mostrar "contador_de_1" en pantalla.
